...
export function Quadro() {
    ...
    return (
        <main className="main">
            <div className="titulopg"><h1>Meu quadro</h1></div>
            <section className="conteiner">
                <Coluna className="tabelas" titulo="A fazer" tarefas={tarefasAfazer} />
                <Coluna className="tabelas" titulo="Fazendo" tarefas={tarefasFazendo} />
                <Coluna className="tabelas" titulo="Pronto" tarefas={tarefasPronto} />
            </section>
        </main>
    );
}
